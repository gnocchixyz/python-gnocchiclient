...
class AggregatesClientTest(base.ClientTestBase):
    def test_scenario(self):
        ...
        self.assertEqual("", metric1["created_by_project_id"])
        self.assertEqual("admin", metric1["created_by_user_id"])
        ...
        self.assertEqual("", metric2["created_by_project_id"])
        self.assertEqual("admin", metric2["created_by_user_id"])
